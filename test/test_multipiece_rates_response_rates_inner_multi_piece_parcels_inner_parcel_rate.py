...
class TestMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate(unittest.TestCase):
    """MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate:
        """Test MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate`
        """
        model = MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate()
        if include_optional:
            return MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate(
                base_charge = 145.36,
    ...
    def testMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate(self):
        """Test MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate"""
