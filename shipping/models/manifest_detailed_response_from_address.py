...
class ManifestDetailedResponseFromAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "addressLine2", "addressLine3", "cityTown", "countryCode", "postalCode", "residential", "stateProvince"]
