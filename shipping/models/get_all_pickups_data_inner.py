...
class GetAllPickupsDataInner(BaseModel):
    """
    ...
    pickup_summary: Optional[List[GetAllPickupsDataInnerPickupSummaryInner]] = Field(default=None, description="It displays the package details provided in the request.", alias="pickupSummary")
    special_instructions: Optional[StrictStr] = Field(default=None, description="It displays additional comments or remarks provided in the request, it would be printed on the scheduled pickup document", alias="specialInstructions")
    ...
    __properties: ClassVar[List[str]] = ["packageLocation", "pickupConfirmationNumber", "pickupId", "carrier", "carrierAccountId", "pickupAddress", "shipmentIds", "pickupSummary", "specialInstructions", "reference", "pickupDateTime", "pickupTotalWeight", "pickupTotalWeightUnit", "pickupOptions", "pickupRate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pickupSummary": [GetAllPickupsDataInnerPickupSummaryInner.from_dict(_item) for _item in obj["pickupSummary"]] if obj.get("pickupSummary") is not None else None,
