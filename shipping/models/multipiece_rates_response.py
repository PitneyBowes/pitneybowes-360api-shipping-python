...
class MultipieceRatesResponse(BaseModel):
    """
    description
    """ # noqa: E501
    ...
    rates: Optional[List[MultipieceRatesResponseRatesInner]] = Field(default=None, description="description")
    __properties: ClassVar[List[str]] = ["fromAddress", "toAddress", "serviceId", "rates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rates": [MultipieceRatesResponseRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
