...
class InternationalShipmentResponseCustoms(BaseModel):
    """
    InternationalShipmentResponseCustoms
    """ # noqa: E501
    customs_info: Optional[InternationalShipmentResponseCustomsCustomsInfo] = Field(default=None, alias="customsInfo")
    customs_items: Optional[List[InternationalShipmentResponseCustomsCustomsItemsInner]] = Field(default=None, alias="customsItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customsInfo": InternationalShipmentResponseCustomsCustomsInfo.from_dict(obj["customsInfo"]) if obj.get("customsInfo") is not None else None,
            "customsItems": [InternationalShipmentResponseCustomsCustomsItemsInner.from_dict(_item) for _item in obj["customsItems"]] if obj.get("customsItems") is not None else None
        })
        return _obj
