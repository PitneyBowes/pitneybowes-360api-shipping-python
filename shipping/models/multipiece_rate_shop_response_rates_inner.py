...
class MultipieceRateShopResponseRatesInner(BaseModel):
    """
    description
    """ # noqa: E501
    ...
    multi_piece_parcels: Optional[List[MultipieceRateShopResponseRatesInnerMultiPieceParcelsInner]] = Field(default=None, description="description", alias="multiPieceParcels")
    surcharges: Optional[List[MultipieceRatesResponseRatesInnerSurchargesInner]] = Field(default=None, description="description")
    __properties: ClassVar[List[str]] = ["totalCarrierCharge", "carrier", "currencyCode", "rateTypeId", "serviceId", "deliveryCommitment", "multiPieceParcels", "surcharges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "multiPieceParcels": [MultipieceRateShopResponseRatesInnerMultiPieceParcelsInner.from_dict(_item) for _item in obj["multiPieceParcels"]] if obj.get("multiPieceParcels") is not None else None,
            "surcharges": [MultipieceRatesResponseRatesInnerSurchargesInner.from_dict(_item) for _item in obj["surcharges"]] if obj.get("surcharges") is not None else None
        })
        return _obj
