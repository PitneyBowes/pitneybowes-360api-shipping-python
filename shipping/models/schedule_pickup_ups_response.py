...
class SchedulePickupUPSResponse(BaseModel):
    """
    ...
    pickup_summary: Optional[List[SchedulePickupUPSResponsePickupSummaryInner]] = Field(default=None, description="It displays the package details provided in the request.", alias="pickupSummary")
    ...
    pickup_options: Optional[SchedulePickupUPSResponsePickupOptions] = Field(default=None, alias="pickupOptions")
    pickup_rate: Optional[SchedulePickupUPSResponsePickupRate] = Field(default=None, alias="pickupRate")
    __properties: ClassVar[List[str]] = ["packageLocation", "pickupConfirmationNumber", "pickupId", "carrier", "carrierAccountId", "pickupAddress", "shipmentIds", "pickupSummary", "additionalnotes", "reference", "pickupDateTime", "pickupTotalWeight", "pickupTotalWeightUnit", "pickupOptions", "pickupRate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of pickup_rate
        if self.pickup_rate:
            _dict['pickupRate'] = self.pickup_rate.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pickupSummary": [SchedulePickupUPSResponsePickupSummaryInner.from_dict(_item) for _item in obj["pickupSummary"]] if obj.get("pickupSummary") is not None else None,
            ...
            "pickupOptions": SchedulePickupUPSResponsePickupOptions.from_dict(obj["pickupOptions"]) if obj.get("pickupOptions") is not None else None,
            "pickupRate": SchedulePickupUPSResponsePickupRate.from_dict(obj["pickupRate"]) if obj.get("pickupRate") is not None else None
        })
        return _obj
