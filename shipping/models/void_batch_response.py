...
class VoidBatchResponse(BaseModel):
    """
    VoidBatchResponse
    """ # noqa: E501
    ...
    status: Optional[StrictStr] = Field(default=None, description="Indicates the status of the Batch while executing `voidShippingLabel`.")
