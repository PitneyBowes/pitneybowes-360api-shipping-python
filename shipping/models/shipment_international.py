...
class ShipmentInternational(BaseModel):
    """
    ShipmentInternational
    """ # noqa: E501
    from_address: ShipmentInternationalFromAddress = Field(alias="fromAddress")
    ...
    date_of_shipment: Optional[StrictStr] = Field(default=None, description="The date of the shipment. The format must be YYY:MM:DD.", alias="dateOfShipment")
    ...
    to_address: ShipmentInternationalToAddress = Field(alias="toAddress")
    customs: ShipmentInternationalCustoms
    __properties: ClassVar[List[str]] = ["fromAddress", "parcel", "carrierAccountId", "parcelType", "serviceId", "dateOfShipment", "specialServices", "shipmentOptions", "metadata", "toAddress", "customs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fromAddress": ShipmentInternationalFromAddress.from_dict(obj["fromAddress"]) if obj.get("fromAddress") is not None else None,
            "parcel": ShipmentInternationalParcel.from_dict(obj["parcel"]) if obj.get("parcel") is not None else None,
            ...
            "toAddress": ShipmentInternationalToAddress.from_dict(obj["toAddress"]) if obj.get("toAddress") is not None else None,
            "customs": ShipmentInternationalCustoms.from_dict(obj["customs"]) if obj.get("customs") is not None else None
        })
        return _obj
