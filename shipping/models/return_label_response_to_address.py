...
class ReturnLabelResponseToAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "email", "cityTown", "countryCode", "name", "phone", "postalCode", "stateProvince"]
