...
class GetShipmentsForBatchDataInnerLabelLayout(BaseModel):
    """
    ...
    print_receipt: Optional[StrictBool] = Field(default=None, description="This option asks if the receipt is to be printed.", alias="printReceipt")
    ...
    type: Optional[StrictStr] = Field(default=None, description="This indicates the type of the label")
    __properties: ClassVar[List[str]] = ["fileFormat", "printReceipt", "size", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "printReceipt": obj.get("printReceipt"),
            "size": obj.get("size"),
            "type": obj.get("type")
        })
        return _obj
