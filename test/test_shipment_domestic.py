...
class TestShipmentDomestic(unittest.TestCase):
    """ShipmentDomestic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShipmentDomestic:
        """Test ShipmentDomestic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentDomestic`
        """
        model = ShipmentDomestic()
        if include_optional:
            return ShipmentDomestic(
                size = 'DOC_4X6',
                type = 'SHIPPING_LABEL',
                format = 'PDF',
                date_of_shipment = '2023-05-25',
                from_address = shipping.models.shipment_domestic_from_address.shipmentDomestic_fromAddress(
                ...
                metadata = [
                    shipping.models.shipment_domestic_metadata_inner.shipmentDomestic_metadata_inner(
                        name = 'costAccountName', 
                        value = 'cost account 123', )
                    ],
                to_address = shipping.models.shipment_domestic_to_address.shipmentDomestic_toAddress(
                    address_line1 = '27 Watervw Dr', 
                    address_line2 = 'near abc street', 
                    address_line3 = 'near xyz street', 
                    city_town = 'Stamford', 
