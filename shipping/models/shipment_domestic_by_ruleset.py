...
class ShipmentDomesticByRuleset(BaseModel):
    """
    ...
    metadata: Optional[List[ShipmentDomesticByRulesetMetadataInner]] = Field(default=None, description="Additional metadata that needs to be stored for this shipment can be added here.<br /> For now, 'Cost Account Name' is supported.")
    ...
    label_format: StrictStr = Field(description="Defines the file/format in which the label is printed. <br /> `Max length = 14`", alias="labelFormat")
    ...
    delivery_option: Optional[ShipmentDomesticByRulesetDeliveryOption] = Field(default=None, alias="deliveryOption")
    __properties: ClassVar[List[str]] = ["fromAddress", "toAddress", "parcel", "parcelType", "rateShopBy", "byRuleSet", "shipmentOptions", "docTab", "deliveryConfirmation", "handling", "insurance", "references", "metadata", "labelSize", "labelType", "labelFormat", "printerAliasName", "dateOfShipment", "deliveryOption"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of by_rule_set
        if self.by_rule_set:
            _dict['byRuleSet'] = self.by_rule_set.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "byRuleSet": ShipmentDomesticByRulesetByRuleSet.from_dict(obj["byRuleSet"]) if obj.get("byRuleSet") is not None else None,
            "shipmentOptions": ShipmentDomesticByRulesetShipmentOptions.from_dict(obj["shipmentOptions"]) if obj.get("shipmentOptions") is not None else None,
            ...
            "metadata": [ShipmentDomesticByRulesetMetadataInner.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
            ...
            "deliveryOption": ShipmentDomesticByRulesetDeliveryOption.from_dict(obj["deliveryOption"]) if obj.get("deliveryOption") is not None else None
        })
        return _obj
