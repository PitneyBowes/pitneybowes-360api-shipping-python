...
class GetAllShipmentsDataInnerRateSpecialServicesInnerInputParametersInner(BaseModel):
    """
    GetAllShipmentsDataInnerRateSpecialServicesInnerInputParametersInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the input parameters.")
    value: Optional[StrictStr] = Field(default=None, description="The value for the input parameters.")
