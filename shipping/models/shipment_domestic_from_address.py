...
class ShipmentDomesticFromAddress(BaseModel):
    """
    ...
    country_code: StrictStr = Field(description="This indicates the two-character ISO code of the source country from the ISO country list.", alias="countryCode")
    ...
    induction_postal_code: Optional[StrictStr] = Field(default=None, description="The postal code where the shipment is tendered to the carrier. If an induction postal code is specified in the \"fromAddress\", it will be used for rate calculations and determining manifest eligibility instead of the standard postal code. If not specified, the postal code from the \"fromAddress\" will be used.", alias="inductionPostalCode")
    __properties: ClassVar[List[str]] = ["addressLine1", "addressLine2", "addressLine3", "cityTown", "countryCode", "name", "company", "phone", "postalCode", "stateProvince", "inductionPostalCode"]
