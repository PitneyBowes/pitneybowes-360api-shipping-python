...
class DomesticShipmentResponseRateSpecialServicesInnerInputParametersInner(BaseModel):
    """
    DomesticShipmentResponseRateSpecialServicesInnerInputParametersInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name or ID of the Input Parameters.")
    value: Optional[StrictStr] = Field(default=None, description="Value of the Input Parameters.")
