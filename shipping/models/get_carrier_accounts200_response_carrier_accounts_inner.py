...
class GetCarrierAccounts200ResponseCarrierAccountsInner(BaseModel):
    """
    GetCarrierAccounts200ResponseCarrierAccountsInner
    """ # noqa: E501
    carrier_account_id: Optional[StrictStr] = Field(default=None, description="A unique identifier assigned to the specific carrier account.", alias="carrierAccountId")
    carrier_name: Optional[StrictStr] = Field(default=None, description="Name of the carrier.", alias="carrierName")
    description: Optional[StrictStr] = Field(default=None, description="Description of this carrier account.")
    __properties: ClassVar[List[str]] = ["carrierAccountId", "carrierName", "description"]
