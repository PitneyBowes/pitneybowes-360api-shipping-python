...
class SingleRateToAddress(BaseModel):
    """
    ...
    email: Optional[StrictStr] = Field(default=None, description="The email address of the recipient. It can be person's email address or company email address (for non-residential).")
