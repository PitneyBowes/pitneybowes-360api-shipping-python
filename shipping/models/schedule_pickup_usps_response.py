...
class SchedulePickupUSPSResponse(BaseModel):
    """
    ...
    pickup_date_time: Optional[StrictStr] = Field(default=None, description="It displays the scheduled pickup date", alias="pickupDateTime")
    ...
    __properties: ClassVar[List[str]] = ["packageLocation", "pickupConfirmationNumber", "pickupId", "carrier", "carrierAccountId", "pickupAddress", "shipmentIds", "pickupSummary", "additionalnotes", "reference", "pickupDateTime", "pickupTotalWeight", "pickupTotalWeightUnit"]
