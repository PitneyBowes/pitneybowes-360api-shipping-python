...
class TestReturnLabelResponseRate(unittest.TestCase):
    """ReturnLabelResponseRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnLabelResponseRate:
        """Test ReturnLabelResponseRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnLabelResponseRate`
        """
        model = ReturnLabelResponseRate()
        if include_optional:
            return ReturnLabelResponseRate(
                base_charge = 30.1,
                carrier = 'UPS',
                currency_code = 'USD',
                parcel_type = 'LTR',
    ...
    def testReturnLabelResponseRate(self):
        """Test ReturnLabelResponseRate"""
