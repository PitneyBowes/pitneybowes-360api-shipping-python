...
class TestMultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInner(unittest.TestCase):
    """MultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInner:
        """Test MultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInner`
        """
        model = MultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInner()
        if include_optional:
            return MultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInner(
                parcel_type = 'PKG',
    ...
    def testMultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInner(self):
        """Test MultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInner"""
