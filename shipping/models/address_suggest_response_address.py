...
class AddressSuggestResponseAddress(BaseModel):
    """
    ...
    country_code: Optional[StrictStr] = Field(default=None, description="This indicates the two-character ISO code of the country from the ISO country list.", alias="countryCode")
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "addressLine2", "addressLine3", "cityTown", "countryCode", "name", "postalCode", "residential", "stateProvince", "status"]
