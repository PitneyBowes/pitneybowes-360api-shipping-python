...
class TestMultipieceRatesResponseRatesInnerMultiPieceParcelsInner(unittest.TestCase):
    """MultipieceRatesResponseRatesInnerMultiPieceParcelsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipieceRatesResponseRatesInnerMultiPieceParcelsInner:
        """Test MultipieceRatesResponseRatesInnerMultiPieceParcelsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipieceRatesResponseRatesInnerMultiPieceParcelsInner`
        """
        model = MultipieceRatesResponseRatesInnerMultiPieceParcelsInner()
        if include_optional:
            return MultipieceRatesResponseRatesInnerMultiPieceParcelsInner(
                parcel_type = 'PKG',
    ...
    def testMultipieceRatesResponseRatesInnerMultiPieceParcelsInner(self):
        """Test MultipieceRatesResponseRatesInnerMultiPieceParcelsInner"""
