...
class MultipieceRateShopResponseRatesInnerMultiPieceParcelsInner(BaseModel):
    """
    description
    """ # noqa: E501
    parcel_type: Optional[StrictStr] = Field(default=None, description="description", alias="parcelType")
    parcel: Optional[MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel] = None
    parcel_rate: Optional[MultipieceRateShopResponseRatesInnerMultiPieceParcelsInnerParcelRate] = Field(default=None, alias="parcelRate")
    __properties: ClassVar[List[str]] = ["parcelType", "parcel", "parcelRate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parcel": MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel.from_dict(obj["parcel"]) if obj.get("parcel") is not None else None,
            "parcelRate": MultipieceRateShopResponseRatesInnerMultiPieceParcelsInnerParcelRate.from_dict(obj["parcelRate"]) if obj.get("parcelRate") is not None else None
        })
        return _obj
