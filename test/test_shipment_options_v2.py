...
class TestShipmentOptionsV2(unittest.TestCase):
    """ShipmentOptionsV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShipmentOptionsV2:
        """Test ShipmentOptionsV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentOptionsV2`
        """
        model = ShipmentOptionsV2()
        if include_optional:
            return ShipmentOptionsV2(
    ...
    def testShipmentOptionsV2(self):
        """Test ShipmentOptionsV2"""
