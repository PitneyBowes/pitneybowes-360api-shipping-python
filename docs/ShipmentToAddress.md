...
json = "{}"
# create an instance of ShipmentToAddress from a JSON string
shipment_to_address_instance = ShipmentToAddress.from_json(json)
# print the JSON string representation of the object
print(ShipmentToAddress.to_json())

# convert the object into a dict
shipment_to_address_dict = shipment_to_address_instance.to_dict()
# create an instance of ShipmentToAddress from a dict
shipment_to_address_from_dict = ShipmentToAddress.from_dict(shipment_to_address_dict)
```
