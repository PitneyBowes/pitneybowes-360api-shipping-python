...
class SingleRateResponseToAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "addressLine2", "addressLine3", "cityTown", "company", "countryCode", "postalCode", "stateProvince"]
