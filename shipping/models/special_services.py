...
class SpecialServices(BaseModel):
    ...
    SpecialServices
    """ # noqa: E501
    services: Optional[List[SpecialServicesServicesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "services": [SpecialServicesServicesInner.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
