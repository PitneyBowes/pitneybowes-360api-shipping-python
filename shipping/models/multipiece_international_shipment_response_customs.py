...
class MultipieceInternationalShipmentResponseCustoms(BaseModel):
    """
    MultipieceInternationalShipmentResponseCustoms
    """ # noqa: E501
    customs_items: List[ShipmentInternationalCustomsCustomsItemsInner] = Field(alias="customsItems")
    customs_info: MultipieceInternationalShipmentResponseCustomsCustomsInfo = Field(alias="customsInfo")
    __properties: ClassVar[List[str]] = ["customsItems", "customsInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customsItems": [ShipmentInternationalCustomsCustomsItemsInner.from_dict(_item) for _item in obj["customsItems"]] if obj.get("customsItems") is not None else None,
            "customsInfo": MultipieceInternationalShipmentResponseCustomsCustomsInfo.from_dict(obj["customsInfo"]) if obj.get("customsInfo") is not None else None
        })
        return _obj
