...
class TestMultipieceRatesResponse(unittest.TestCase):
    """MultipieceRatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipieceRatesResponse:
        """Test MultipieceRatesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipieceRatesResponse`
        """
        model = MultipieceRatesResponse()
        if include_optional:
            return MultipieceRatesResponse(
    ...
    def testMultipieceRatesResponse(self):
        """Test MultipieceRatesResponse"""
