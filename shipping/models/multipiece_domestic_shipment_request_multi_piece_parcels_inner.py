...
class MultipieceDomesticShipmentRequestMultiPieceParcelsInner(BaseModel):
    """
    ...
    parcel: Optional[MultipieceDomesticShipmentRequestMultiPieceParcelsInnerParcel] = None
    __properties: ClassVar[List[str]] = ["parcelType", "parcel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parcel": MultipieceDomesticShipmentRequestMultiPieceParcelsInnerParcel.from_dict(obj["parcel"]) if obj.get("parcel") is not None else None
        })
        return _obj
