...
class BPODDownloadResponse(BaseModel):
    """
    BPODDownloadResponse
    """ # noqa: E501
    file_url: Optional[StrictStr] = Field(default=None, description="This is the URL for the BPOD (Bulk Proof of Delivery) ZIP file.", alias="fileURL")
