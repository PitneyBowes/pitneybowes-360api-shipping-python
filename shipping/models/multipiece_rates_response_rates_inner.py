...
class MultipieceRatesResponseRatesInner(BaseModel):
    """
    description
    """ # noqa: E501
    ...
    multi_piece_parcels: Optional[List[MultipieceRatesResponseRatesInnerMultiPieceParcelsInner]] = Field(default=None, description="description", alias="multiPieceParcels")
    surcharges: Optional[List[MultipieceRatesResponseRatesInnerSurchargesInner]] = Field(default=None, description="description")
    __properties: ClassVar[List[str]] = ["totalCarrierCharge", "carrier", "currencyCode", "rateTypeId", "serviceId", "multiPieceParcels", "surcharges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "multiPieceParcels": [MultipieceRatesResponseRatesInnerMultiPieceParcelsInner.from_dict(_item) for _item in obj["multiPieceParcels"]] if obj.get("multiPieceParcels") is not None else None,
