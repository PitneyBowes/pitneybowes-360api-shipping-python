...
class AllDefaults(BaseModel):
    ...
    AllDefaults
    """ # noqa: E501
    page_info: Optional[AllDefaultsPageInfo] = Field(default=None, alias="pageInfo")
    data: Optional[List[AllDefaultsDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pageInfo": AllDefaultsPageInfo.from_dict(obj["pageInfo"]) if obj.get("pageInfo") is not None else None,
            "data": [AllDefaultsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
