...
class MultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInnerParcelRate(BaseModel):
    """
    description
    """ # noqa: E501
    base_charge: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="description", alias="baseCharge")
    surcharges: Optional[List[MultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInnerParcelRateSurchargesInner]] = Field(default=None, description="description")
    __properties: ClassVar[List[str]] = ["baseCharge", "surcharges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "surcharges": [MultipieceDomesticShipmentResponseMultiPieceRatesInnerMultiPieceParcelsInnerParcelRateSurchargesInner.from_dict(_item) for _item in obj["surcharges"]] if obj.get("surcharges") is not None else None
        })
        return _obj
