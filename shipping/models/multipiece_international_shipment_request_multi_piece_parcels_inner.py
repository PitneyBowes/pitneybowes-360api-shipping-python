...
class MultipieceInternationalShipmentRequestMultiPieceParcelsInner(BaseModel):
    """
    ...
    parcel_id: Optional[StrictStr] = Field(default=None, description="Description", alias="parcelId")
    parcel: Optional[MultipieceInternationalShipmentRequestMultiPieceParcelsInnerParcel] = None
    __properties: ClassVar[List[str]] = ["parcelType", "parcelId", "parcel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parcel": MultipieceInternationalShipmentRequestMultiPieceParcelsInnerParcel.from_dict(obj["parcel"]) if obj.get("parcel") is not None else None
        })
        return _obj
