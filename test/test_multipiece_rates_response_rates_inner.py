...
class TestMultipieceRatesResponseRatesInner(unittest.TestCase):
    """MultipieceRatesResponseRatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipieceRatesResponseRatesInner:
        """Test MultipieceRatesResponseRatesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipieceRatesResponseRatesInner`
        """
        model = MultipieceRatesResponseRatesInner()
        if include_optional:
            return MultipieceRatesResponseRatesInner(
    ...
    def testMultipieceRatesResponseRatesInner(self):
        """Test MultipieceRatesResponseRatesInner"""
