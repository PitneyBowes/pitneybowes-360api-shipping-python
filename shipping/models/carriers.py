...
class Carriers(BaseModel):
    ...
    Carriers
    """ # noqa: E501
    carriers: Optional[List[CarriersCarriersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "carriers": [CarriersCarriersInner.from_dict(_item) for _item in obj["carriers"]] if obj.get("carriers") is not None else None
        })
        return _obj
