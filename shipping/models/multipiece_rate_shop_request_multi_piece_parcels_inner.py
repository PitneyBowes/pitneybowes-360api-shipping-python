...
class MultipieceRateShopRequestMultiPieceParcelsInner(BaseModel):
    """
    description
    """ # noqa: E501
    parcel_type: Optional[StrictStr] = Field(default=None, description="description", alias="parcelType")
    parcel: Optional[MultipieceRateShopRequestMultiPieceParcelsInnerParcel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parcel": MultipieceRateShopRequestMultiPieceParcelsInnerParcel.from_dict(obj["parcel"]) if obj.get("parcel") is not None else None
        })
        return _obj
