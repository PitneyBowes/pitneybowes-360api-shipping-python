...
class ShipmentDomesticByRateGroup(BaseModel):
    """
    ...
    by_rate_group: Optional[ShipmentDomesticByRateGroupByRateGroup] = Field(default=None, alias="byRateGroup")
    shipment_options: Optional[ShipmentDomesticByRateGroupShipmentOptions] = Field(default=None, alias="shipmentOptions")
    ...
    metadata: Optional[List[ShipmentDomesticByRateGroupMetadataInner]] = Field(default=None, description="Additional metadata that needs to be stored for this shipment can be added here.<br /> For now, 'Cost Account Name' is supported.")
    ...
    __properties: ClassVar[List[str]] = ["fromAddress", "toAddress", "parcel", "parcelType", "rateShopBy", "byRateGroup", "shipmentOptions", "docTab", "deliveryConfirmation", "handling", "insurance", "references", "metadata", "labelSize", "labelType", "labelFormat", "printerAliasName", "dateOfShipment", "deliveryOption"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of by_rate_group
        if self.by_rate_group:
            _dict['byRateGroup'] = self.by_rate_group.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "byRateGroup": ShipmentDomesticByRateGroupByRateGroup.from_dict(obj["byRateGroup"]) if obj.get("byRateGroup") is not None else None,
            "shipmentOptions": ShipmentDomesticByRateGroupShipmentOptions.from_dict(obj["shipmentOptions"]) if obj.get("shipmentOptions") is not None else None,
            ...
            "metadata": [ShipmentDomesticByRateGroupMetadataInner.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
