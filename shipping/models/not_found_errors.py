...
class NotFoundErrors(BaseModel):
    ...
    NotFoundErrors
    """ # noqa: E501
    errors: Optional[List[NotFoundErrorsErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [NotFoundErrorsErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
