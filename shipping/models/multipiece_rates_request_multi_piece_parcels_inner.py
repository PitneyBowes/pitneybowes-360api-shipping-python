...
class MultipieceRatesRequestMultiPieceParcelsInner(BaseModel):
    """
    description
    """ # noqa: E501
    ...
    parcel: Optional[MultipieceRatesRequestMultiPieceParcelsInnerParcel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parcel": MultipieceRatesRequestMultiPieceParcelsInnerParcel.from_dict(obj["parcel"]) if obj.get("parcel") is not None else None
        })
        return _obj
