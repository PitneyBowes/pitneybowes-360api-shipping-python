...
class TestGetAllPickupsDataInner(unittest.TestCase):
    """GetAllPickupsDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllPickupsDataInner:
        """Test GetAllPickupsDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllPickupsDataInner`
        """
        model = GetAllPickupsDataInner()
        if include_optional:
            return GetAllPickupsDataInner(
    ...
    def testGetAllPickupsDataInner(self):
        """Test GetAllPickupsDataInner"""
