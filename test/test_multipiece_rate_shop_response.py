...
class TestMultipieceRateShopResponse(unittest.TestCase):
    """MultipieceRateShopResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipieceRateShopResponse:
        """Test MultipieceRateShopResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipieceRateShopResponse`
        """
        model = MultipieceRateShopResponse()
        if include_optional:
            return MultipieceRateShopResponse(
                ...
                service_id = 'NDA',
                rates = [
                    shipping.models.multipiece_rate_shop_response_rates_inner.MultipieceRateShopResponse_rates_inner(
                        ...
                        multi_piece_parcels = [
                            shipping.models.multipiece_rate_shop_response_rates_inner_multi_piece_parcels_inner.MultipieceRateShopResponse_rates_inner_multiPieceParcels_inner(
                                parcel_type = 'PKG', 
                                parcel = shipping.models.multipiece_rates_response_rates_inner_multi_piece_parcels_inner_parcel.MultipieceRatesResponse_rates_inner_multiPieceParcels_inner_parcel(
                                    ...
                                    weight_unit = 'OZ', 
                                    weight = 16, ), 
                                parcel_rate = shipping.models.multipiece_rate_shop_response_rates_inner_multi_piece_parcels_inner_parcel_rate.MultipieceRateShopResponse_rates_inner_multiPieceParcels_inner_parcelRate(
                                    base_charge = 145.36, 
                                    surcharges = [
    ...
    def testMultipieceRateShopResponse(self):
        """Test MultipieceRateShopResponse"""
