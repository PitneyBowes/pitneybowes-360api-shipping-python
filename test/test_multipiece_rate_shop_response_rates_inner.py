...
class TestMultipieceRateShopResponseRatesInner(unittest.TestCase):
    """MultipieceRateShopResponseRatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipieceRateShopResponseRatesInner:
        """Test MultipieceRateShopResponseRatesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipieceRateShopResponseRatesInner`
        """
        model = MultipieceRateShopResponseRatesInner()
        if include_optional:
            return MultipieceRateShopResponseRatesInner(
    ...
    def testMultipieceRateShopResponseRatesInner(self):
        """Test MultipieceRateShopResponseRatesInner"""
