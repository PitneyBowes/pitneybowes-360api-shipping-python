...
class SpecialServicesServicesInnerParcelTypeRulesInnerSpecialServiceRulesInnerPrerequisiteRulesInner(BaseModel):
    """
    SpecialServicesServicesInnerParcelTypeRulesInnerSpecialServiceRulesInnerPrerequisiteRulesInner
    """ # noqa: E501
    specialservice_id: Optional[StrictStr] = Field(default=None, alias="specialserviceId")
