...
class SchedulePickupUPSRequest(BaseModel):
    """
    SchedulePickupUPSRequest
    """ # noqa: E501
    package_location: StrictStr = Field(description="It specifies the location from where packages would be collected. Applicable values are `Front Door`,`Back Door`,`Side Door`,`Shipping`,`Receiving`,`Knock on Door/Ring Bell`,`Mail Room`,`Garage`,`Office`,`Downstairs`,`Reception`,`In/At Mailbox`,`Third Party`,`Warehouse`,`Other`", alias="packageLocation")
    ...
    pickup_summary: Optional[List[SchedulePickupUPSRequestPickupSummaryInner]] = Field(default=None, description="This can be used to add package details for which labels are not created yet but would want to schedule pickup in advance.", alias="pickupSummary")
    additionalnotes: Optional[StrictStr] = Field(default=None, description="It can be used to provide any additional comments or remarks, it would be printed on the scheduled pickup document. It is required when packageLocation is set to `Other`.")
    reference: Optional[StrictStr] = Field(default=None, description="It is used for any reference purpose")
    pickup_options: SchedulePickupUPSRequestPickupOptions = Field(alias="pickupOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pickupSummary": [SchedulePickupUPSRequestPickupSummaryInner.from_dict(_item) for _item in obj["pickupSummary"]] if obj.get("pickupSummary") is not None else None,
            "additionalnotes": obj.get("additionalnotes"),
            "reference": obj.get("reference"),
            "pickupOptions": SchedulePickupUPSRequestPickupOptions.from_dict(obj["pickupOptions"]) if obj.get("pickupOptions") is not None else None
        })
        return _obj
