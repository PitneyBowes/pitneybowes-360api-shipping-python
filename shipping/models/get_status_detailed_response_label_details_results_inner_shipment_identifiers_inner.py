...
class GetStatusDetailedResponseLabelDetailsResultsInnerShipmentIdentifiersInner(BaseModel):
    """
    GetStatusDetailedResponseLabelDetailsResultsInnerShipmentIdentifiersInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description=" This indicates the identifier at DB level mapped with Shipment ID.")
    ...
    __properties: ClassVar[List[str]] = ["id", "shipmentId", "externalId"]
