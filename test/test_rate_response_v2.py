...
class TestRateResponseV2(unittest.TestCase):
    """RateResponseV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateResponseV2:
        """Test RateResponseV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateResponseV2`
        """
        model = RateResponseV2()
        if include_optional:
            return RateResponseV2(
                base_charge = 16.15,
                carrier = 'PUROLATOR',
                currency_code = 'CAD',
                parcel_type = 'PKG',
