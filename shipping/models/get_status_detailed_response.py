...
class GetStatusDetailedResponse(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description=" Name of the of Batch which consists of multiple shipments (shipments in bulk).")
    ...
    var_import: Optional[Dict[str, Any]] = Field(default=None, alias="import")
    ...
    void_label: Optional[Dict[str, Any]] = Field(default=None, alias="voidLabel")
    label_details: Optional[GetStatusDetailedResponseLabelDetails] = Field(default=None, alias="labelDetails")
    __properties: ClassVar[List[str]] = ["batchId", "name", "groupName", "status", "import", "addressValidation", "rating", "labelGeneration", "voidLabel", "labelDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of void_label
        if self.void_label:
            _dict['voidLabel'] = self.void_label.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "import": ImportCountStatus.from_dict(obj["import"]) if obj.get("import") is not None else None,
            "addressValidation": AddressCountStatus.from_dict(obj["addressValidation"]) if obj.get("addressValidation") is not None else None,
            "rating": RatingCountStatus.from_dict(obj["rating"]) if obj.get("rating") is not None else None,
            ...
            "voidLabel": VoidCountStatus.from_dict(obj["voidLabel"]) if obj.get("voidLabel") is not None else None,
            "labelDetails": GetStatusDetailedResponseLabelDetails.from_dict(obj["labelDetails"]) if obj.get("labelDetails") is not None else None
        })
        return _obj
