...
class SpecialServiceBatch(BaseModel):
    """
    SpecialServiceBatch
    """ # noqa: E501
    ...
    specialservice_id: StrictStr = Field(description="A unique identifier associated with the special service to be applied.", alias="specialserviceId")
