...
class ShipmentDomesticByRateGroupMetadataInner(BaseModel):
    """
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the Cost Account which are linked to Shipment.")
    value: Optional[StrictStr] = Field(default=None, description="Indicates the value for the CostAccount.")
