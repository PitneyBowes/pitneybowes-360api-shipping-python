...
class TestMultipieceDomesticShipmentResponseMultiPieceRatesInner(unittest.TestCase):
    """MultipieceDomesticShipmentResponseMultiPieceRatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipieceDomesticShipmentResponseMultiPieceRatesInner:
        """Test MultipieceDomesticShipmentResponseMultiPieceRatesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipieceDomesticShipmentResponseMultiPieceRatesInner`
        """
        model = MultipieceDomesticShipmentResponseMultiPieceRatesInner()
        if include_optional:
            return MultipieceDomesticShipmentResponseMultiPieceRatesInner(
    ...
    def testMultipieceDomesticShipmentResponseMultiPieceRatesInner(self):
        """Test MultipieceDomesticShipmentResponseMultiPieceRatesInner"""
