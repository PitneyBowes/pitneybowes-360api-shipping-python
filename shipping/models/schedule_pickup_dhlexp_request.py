...
class SchedulePickupDHLEXPRequest(BaseModel):
    """
    It specifies the request body for scheduling pickup for DHL Express
    """ # noqa: E501
    package_location: StrictStr = Field(description="It specifies the location from where packages would be collected. Applicable values are `NONE`, `FRONT`,`RECEPTION`,`BACK`,`LOADING DOCK`", alias="packageLocation")
    ...
    pickup_summary: Optional[List[SchedulePickupDHLEXPRequestPickupSummaryInner]] = Field(default=None, description="This can be used to add package details for which labels are not created yet but would want to schedule pickup in advance.", alias="pickupSummary")
    ...
    pickup_options: SchedulePickupDHLEXPRequestPickupOptions = Field(alias="pickupOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pickupSummary": [SchedulePickupDHLEXPRequestPickupSummaryInner.from_dict(_item) for _item in obj["pickupSummary"]] if obj.get("pickupSummary") is not None else None,
            "additionalnotes": obj.get("additionalnotes"),
            "reference": obj.get("reference"),
            "pickupOptions": SchedulePickupDHLEXPRequestPickupOptions.from_dict(obj["pickupOptions"]) if obj.get("pickupOptions") is not None else None
        })
        return _obj
