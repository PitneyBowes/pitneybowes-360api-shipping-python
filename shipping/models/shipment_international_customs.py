...
class ShipmentInternationalCustoms(BaseModel):
    """
    ShipmentInternationalCustoms
    """ # noqa: E501
    customs_items: Optional[List[ShipmentInternationalCustomsCustomsItemsInner]] = Field(default=None, alias="customsItems")
    customs_info: ShipmentInternationalCustomsCustomsInfo = Field(alias="customsInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customsInfo": ShipmentInternationalCustomsCustomsInfo.from_dict(obj["customsInfo"]) if obj.get("customsInfo") is not None else None
        })
        return _obj
