...
class Customs(BaseModel):
    ...
    Customs
    """ # noqa: E501
    customs_info: CustomsInfo = Field(alias="customsInfo")
    customs_items: List[CustomsItem] = Field(description="This operation asks the information for each commodity for Customs clearance.", alias="customsItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customsInfo": CustomsInfo.from_dict(obj["customsInfo"]) if obj.get("customsInfo") is not None else None,
            "customsItems": [CustomsItem.from_dict(_item) for _item in obj["customsItems"]] if obj.get("customsItems") is not None else None
        })
        return _obj
