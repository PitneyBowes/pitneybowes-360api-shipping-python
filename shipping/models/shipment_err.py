...
class ShipmentERR(BaseModel):
    ...
    parcel_type: Optional[StrictStr] = Field(default=None, description=">-Packaging type varies as per selected carrier and its services, e.g., PKG, LGENV.", alias="parcelType")
    service_id: Optional[StrictStr] = Field(default=None, description=">-The unique identifier given to the carrier-specific service. ERR supports two services: First Class Mail (FCM) and Priority Mail (PM).", alias="serviceId")
    date_of_shipment: Optional[StrictStr] = Field(default=None, description="Indicates the date when shipment is created.", alias="dateOfShipment")
    ...
    metadata: Optional[List[ShipmentERRMetadataInner]] = Field(default=None, description="Additional metadata that needs to be stored for this shipment can be added here. For now, `costAccountName` is supported.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": [ShipmentERRMetadataInner.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None
        })
        return _obj
