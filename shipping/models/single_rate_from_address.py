...
class SingleRateFromAddress(BaseModel):
    """
    ...
    city_town: Optional[StrictStr] = Field(default=None, description="The name of the city or town to where the sender's address belongs.", alias="cityTown")
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "addressLine2", "addressLine3", "cityTown", "company", "countryCode", "email", "name", "phone", "postalCode", "stateProvince", "residential"]
