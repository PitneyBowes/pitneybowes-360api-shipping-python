...
class DomesticShipmentResponseToAddress(BaseModel):
    """
    ...
    country_code: Optional[StrictStr] = Field(default=None, description="This indicates the two-character ISO code of the destination country from the ISO country list.", alias="countryCode")
