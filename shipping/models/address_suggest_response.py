...
class AddressSuggestResponse(BaseModel):
    ...
    """ # noqa: E501
    address: Optional[AddressSuggestResponseAddress] = None
    suggestions: Optional[AddressSuggestResponseSuggestions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address": AddressSuggestResponseAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "suggestions": AddressSuggestResponseSuggestions.from_dict(obj["suggestions"]) if obj.get("suggestions") is not None else None
        })
        return _obj
