...
class ProcessShipmentResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description=" The batch will show the status `SUBMITTED` on successful execution of Batch.")
    __properties: ClassVar[List[str]] = ["batchId", "name", "groupName", "status"]
