...
class ReturnLabelToAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "email", "cityTown", "countryCode", "name", "company", "phone", "postalCode", "stateProvince"]
