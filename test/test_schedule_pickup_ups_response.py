...
class TestSchedulePickupUPSResponse(unittest.TestCase):
    """SchedulePickupUPSResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchedulePickupUPSResponse:
        """Test SchedulePickupUPSResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SchedulePickupUPSResponse`
        """
        model = SchedulePickupUPSResponse()
        if include_optional:
            return SchedulePickupUPSResponse(
                ...
                pickup_summary = [
                    shipping.models.schedule_pickup_ups_response_pickup_summary_inner.schedulePickupUPSResponse_pickupSummary_inner(
                        service_id = 'NDA', 
                        package_count = 2, 
                        total_weight = 15, 
                        weight_unit = 'OZ', 
                ...
                pickup_options = shipping.models.schedule_pickup_ups_response_pickup_options.schedulePickupUPSResponse_pickupOptions(
    ...
    def testSchedulePickupUPSResponse(self):
        """Test SchedulePickupUPSResponse"""
