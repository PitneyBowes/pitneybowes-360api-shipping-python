...
class MultipieceInternationalShipmentRequestCustoms(BaseModel):
    """
    ...
    customs_info: MultipieceInternationalShipmentRequestCustomsCustomsInfo = Field(alias="customsInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customsInfo": MultipieceInternationalShipmentRequestCustomsCustomsInfo.from_dict(obj["customsInfo"]) if obj.get("customsInfo") is not None else None
        })
        return _obj
