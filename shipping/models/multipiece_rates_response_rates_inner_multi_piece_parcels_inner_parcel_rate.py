...
class MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate(BaseModel):
    """
    description
    """ # noqa: E501
    ...
    surcharges: Optional[List[MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRateSurchargesInner]] = Field(default=None, description="description")
    __properties: ClassVar[List[str]] = ["baseCharge", "deliveryCommitment", "surcharges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "surcharges": [MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRateSurchargesInner.from_dict(_item) for _item in obj["surcharges"]] if obj.get("surcharges") is not None else None
        })
        return _obj
