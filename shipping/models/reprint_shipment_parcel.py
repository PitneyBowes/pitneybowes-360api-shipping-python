...
class ReprintShipmentParcel(BaseModel):
    """
    ...
    weight_unit: StrictStr = Field(description="WeightUnit is a standard for measuring the physical quantities of specified weight. <br> The valid values are:  <br>- OZ: Ounces <br>- GM: Grams <br>- LB: Pounds <br>- KG: Kilograms For USPS shipments, set this to OZ.", alias="weightUnit")
    weight: Union[StrictFloat, StrictInt] = Field(description="Weight is the measure of how heavy an object is.")
