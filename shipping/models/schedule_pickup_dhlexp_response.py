...
class SchedulePickupDHLEXPResponse(BaseModel):
    """
    ...
    pickup_summary: Optional[List[SchedulePickupDHLEXPResponsePickupSummaryInner]] = Field(default=None, description="It displays the package details provided in the request.", alias="pickupSummary")
    ...
    pickup_options: Optional[SchedulePickupDHLEXPResponsePickupOptions] = Field(default=None, alias="pickupOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pickupSummary": [SchedulePickupDHLEXPResponsePickupSummaryInner.from_dict(_item) for _item in obj["pickupSummary"]] if obj.get("pickupSummary") is not None else None,
            ...
            "pickupOptions": SchedulePickupDHLEXPResponsePickupOptions.from_dict(obj["pickupOptions"]) if obj.get("pickupOptions") is not None else None
        })
        return _obj
