...
class ShipmentBatchResponseERR(BaseModel):
    """
    ShipmentBatchResponseERR
    """ # noqa: E501
    batch_id: Optional[StrictStr] = Field(default=None, description="This is a system-generated unique identifier assigned to the ERR Batch while it is processed.", alias="batchId")
    ...
    upload_url: Optional[StrictStr] = Field(default=None, description="For the stored Batch file under S3, this is the S3 returned URL. The URL is uploaded along with the .CSV file to get the BatchID, which is used to track the import status.", alias="uploadURL")
    __properties: ClassVar[List[str]] = ["batchId", "name", "groupName", "status", "uploadURL"]
