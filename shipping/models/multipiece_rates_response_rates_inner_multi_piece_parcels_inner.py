...
class MultipieceRatesResponseRatesInnerMultiPieceParcelsInner(BaseModel):
    """
    description
    """ # noqa: E501
    ...
    parcel_rate: Optional[MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate] = Field(default=None, alias="parcelRate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parcelRate": MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcelRate.from_dict(obj["parcelRate"]) if obj.get("parcelRate") is not None else None
        })
        return _obj
