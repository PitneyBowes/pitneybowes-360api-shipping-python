...
class InternationalShipmentResponseRateSpecialServicesInnerInputParametersInner(BaseModel):
    """
    InternationalShipmentResponseRateSpecialServicesInnerInputParametersInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the input parameters.")
    value: Optional[StrictStr] = Field(default=None, description="Value for the input parameters.")
