...
class CreateManifestRequestFromAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "addressLine2", "addressLine3", "cityTown", "company", "countryCode", "email", "name", "phone", "postalCode", "stateProvince"]
