...
class BulkShipmentResponse(BaseModel):
    ...
    """ # noqa: E501
    batch_id: Optional[StrictStr] = Field(default=None, description=" This is the system generated Batch ID.", alias="batchId")
    group_name: Optional[StrictStr] = Field(default=None, description="This indicates group name for the Batch.", alias="groupName")
    ...
    __properties: ClassVar[List[str]] = ["batchId", "groupName", "name", "status", "addressValidation", "rating", "labelGeneration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addressValidation": CounterStatus.from_dict(obj["addressValidation"]) if obj.get("addressValidation") is not None else None,
            "rating": CounterStatus.from_dict(obj["rating"]) if obj.get("rating") is not None else None,
            "labelGeneration": CounterStatus.from_dict(obj["labelGeneration"]) if obj.get("labelGeneration") is not None else None
        })
        return _obj
