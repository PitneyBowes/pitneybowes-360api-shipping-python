...
json = "{}"
# create an instance of CreateManifestRequestFromAddress from a JSON string
create_manifest_request_from_address_instance = CreateManifestRequestFromAddress.from_json(json)
# print the JSON string representation of the object
print(CreateManifestRequestFromAddress.to_json())

# convert the object into a dict
create_manifest_request_from_address_dict = create_manifest_request_from_address_instance.to_dict()
# create an instance of CreateManifestRequestFromAddress from a dict
create_manifest_request_from_address_from_dict = CreateManifestRequestFromAddress.from_dict(create_manifest_request_from_address_dict)
```
